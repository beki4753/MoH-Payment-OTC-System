...
const Sidebar = ({ isCollapsed, setIsCollapsed }) => {
	const role = Object.entries(tokenvalue).some(([key, value]) => value.length > 0)
			...
			<ProSidebar collapsed={isCollapsed}>
				<Menu iconShape="square">
					...
					<Box paddingLeft={isCollapsed ? undefined : '10%'}>
						...
						{role?.toUpperCase() === 'USER' && tokenvalue?.UserType === 'MLT' && (
							<>
								{!isCollapsed && (
									<Typography variant="h6" color={colors.grey[300]} sx={{ m: '15px 0 5px 20px' }}>
						...
						{role?.toUpperCase() === 'USER' &&
							(tokenvalue?.UserType?.toUpperCase() === 'CASHIER' ||
								...
								<>
									...
									{tokenvalue?.UserType?.toUpperCase() === 'CASHIER' && !isCollapsed && (
										<Typography variant="h6" color={colors.grey[300]} sx={{ m: '15px 0 5px 20px' }}>
											Money Refund
										</Typography>
									)}
